...
arrow_left=(arrow_top[0]-15, arrow_top[1]+20)
arrow_right=(arrow_top[0]+15, arrow_top[1]+20)
d.line([arrow_bottom, arrow_top], fill=stroke, width=5)
d.line([arrow_top, arrow_left], fill=stroke, width=5)
d.line([arrow_top, arrow_right], fill=stroke, width=5)
