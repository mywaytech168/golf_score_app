...
namespace UploadServer.Migrations
{
    ...
    [Migration("20260614075842_AddSwingMetricsJson")]
    partial class AddSwingMetricsJson
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UploadServer.Models.AdRewardEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("TransactionId")
                        .IsUnique()
                        .HasDatabaseName("uk_are_transaction_id");

                    b.HasIndex("UserId", "ClaimedAt")
                        .HasDatabaseName("idx_are_user_claimed");

                    b.ToTable("ad_reward_events", (string)null);
                });
            ...
            modelBuilder.Entity("UploadServer.Models.AiCoachAnalysis", b =>
                {
                    ...
                    b.Property<string>("SwingMetricsJson")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("UploadServer.Models.Announcement", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("varchar(36)")
                    ...
                    b.HasIndex("ExpiresAt")
                        .HasDatabaseName("idx_ann_expires_at");

                    b.HasIndex("IsActive")
                        .HasDatabaseName("idx_ann_is_active");

                    b.HasIndex("PublishedAt")
                        .HasDatabaseName("idx_ann_published_at");
            ...
            modelBuilder.Entity("UploadServer.Models.DatasetUpload", b =>
                {
                    ...
                    b.Property<string>("B2CsvKey")
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)")
                        .HasColumnName("b2_csv_key");

                    b.Property<string>("B2VideoKey")
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)")
                    ...
                    b.ToTable("dataset_uploads", (string)null);
                });
            ...
            modelBuilder.Entity("UploadServer.Models.UserFeedback", b =>
                {
                    ...
                    b.Property<string>("AttachedImageB2Key")
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)")
                        .HasColumnName("attached_image_b2_key");

                    b.Property<string>("AttachedVideoId")
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)")
